...
public class MyResource {
	...
	@Path("getPatientByUserPass/{loginId}/{password}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Object getPatientByUserPass(@PathParam("loginId") String loginId, @PathParam("password") String password) {
		System.out.println("Recieved path params: " + loginId + " " + password);
		PatientDao patientDao = new PatientDao();
		Patient patient = (Patient) patientDao.getPatientByUserPass(loginId, password);
		return patient;
	}
